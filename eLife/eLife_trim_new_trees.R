...
trim_tree = function(species, num){
  print(species)
  #load tree
  path = paste0("/home/sanna/projects/def-shapiro/sanna/aim1and2/eLife_review_Feb2023/ancestral_seq_iqtree/all_treefiles/", species, "_subtree_msa_", num, ".fasta.treefile")
  tree = read.tree(path)
  print("tree loaded")
  ...
  #write mew tree
  path = paste0("/home/sanna/projects/def-shapiro/sanna/aim1and2/eLife_review_Feb2023/ancestral_seq_iqtree/all_treefiles/", species, "_subtree_", num, "_trimmed.nwk")
