...
if __name__ == '__main__':
    ...
    parser.add_argument("--name", type=str,required=True, help="FASTA file of output alignment") #remove this if code breaks
    ...
    sana_matrix_name = args.name #remove this if code breaks
    ...
    np.savetxt(sana_matrix_name, d, fmt='%f') 
    fh_out.close()